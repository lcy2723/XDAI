complex_type2qa_examples = {
    ...
    "方法类": [
        {"q": "时间复杂度怎么算?",
         ...
         "class": "工学"},
        {"q": "特征值怎么求?",
         "a": "求解矩阵A的特征值，首先计算特征多项式| A - lambda I|，然后求使得| A - lambda I|=0的所有lambda的值，所求得的lambda即为矩阵A的特征值。",
         "class": "理学"},
        {"q": "二进制补码怎么算?", "a": "对正数而言，其补码就是原码；对于负数而言，先将原码各位取反求出其反码，再将反码加一得到其补码", "class": "工学"},
        {"q": "十进制数转二进制数怎么转换?",
